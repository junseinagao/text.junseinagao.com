...
.group:hover .link-hover {
  --tw-text-opacity: 1;
  color: rgb(197 138 140 / var(--tw-text-opacity));
...
.border-brand-sub {
  --tw-border-opacity: 1;
  border-color: rgb(113 135 145 / var(--tw-border-opacity));
}

.bg-brand-base {
  --tw-bg-opacity: 1;
  background-color: rgb(231 235 223 / var(--tw-bg-opacity));
}

.bg-brand-base-accent {
  --tw-bg-opacity: 1;
  background-color: rgb(236 240 210 / var(--tw-bg-opacity));
}
...
.text-brand-text {
  --tw-text-opacity: 1;
  color: rgb(45 54 58 / var(--tw-text-opacity));
}
...
body {
  font-family: din-2014, zen-old-mincho, system-ui, -apple-system,
...
.group:hover .group-hover\:text-brand-red-dark {
  --tw-text-opacity: 1;
  color: rgb(197 138 140 / var(--tw-text-opacity));
}
